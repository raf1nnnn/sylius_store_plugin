...
namespace spec\Dotit\SyliusStorePlugin\Entity;
...
final class VendorSpec extends ObjectBehavior
{
    ...
    function it_allows_access_via_properties(): void
    {
        ...
        $this->setEmail('vendor@dotit.com.ar');
        $this->getEmail()->shouldReturn('vendor@dotit.com.ar');

        $file = new File(__DIR__ . '/VendorSpec.php');
        $this->setLogoFile($file);
        $this->getLogoFile()->shouldReturn($file);

        $this->setLogoName('dotit logo');
        $this->getLogoName()->shouldReturn('dotit logo');
    }
