...
namespace Tests\Dotit\SyliusStorePlugin\Behat\Context\Setup;

use Behat\Behat\Context\Context;
use Dotit\SyliusStorePlugin\Entity\VendorAwareInterface;
use Dotit\SyliusStorePlugin\Entity\VendorInterface;
use Dotit\SyliusStorePlugin\Repository\VendorRepositoryInterface;
use Dotit\SyliusStorePlugin\Uploader\VendorLogoUploaderInterface;
...
final class VendorContext implements Context
{
    ...
    private function createVendor(string $name): VendorInterface
    {
        ...
        $vendor->setEmail(strtolower($name).'@dotit.com.ar');
        ...
        $uploadedFile = new UploadedFile(__DIR__.'/../../Resources/images/logo_dotit.png', 'logo_dotit.png');
